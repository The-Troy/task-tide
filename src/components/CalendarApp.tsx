  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 lg:col-span-2 order-1">
          <FullCalendar
        ...
        <div className="space-y-6 order-2">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <h3 className="font-semibold text-base text-gray-900">{event.title}</h3>
                            {event.type === 'holiday' && (
          ...
          {/* Events List Card */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4">All Events ({allEvents.length})</h2>
